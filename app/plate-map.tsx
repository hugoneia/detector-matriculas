  ...
  <script>
    ...
    try {
      ...
      window.updateMapData = function(entries, fitBounds) {
        ...
        // fitBounds SIEMPRE si hay marcadores válidos — sin condiciones adicionales
        if (hasValidMarkers) {
          try {
            var groupBounds = markerClusterGroup.getBounds();
...
export default function PlateMapScreen() {
  ...
  return (
    ...
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top, paddingBottom: insets.bottom }}>
      {/* Header Anclado */}
      <View style={{ backgroundColor: colors.surface, borderBottomColor: colors.border, borderBottomWidth: 1, padding: 16, zIndex: 10000 }}>
      ...
      {/* Indicador de Carga — burbuja flotante, NO bloquea toques */}
      {isLoading && (
        <View
          style={{
            position: "absolute",
